...
{
    public class Physician : DomainEntity<int>,IDateTracking
    {
        #region Constructors
        ...
        /// <summary>
        /// Gets or sets the Address of this Physician.
        /// </summary>

        public Address AddressPhysician { get; set; }
